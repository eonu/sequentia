...
def test_downsample_single_decimate_max():
    ...
    assert_arrays_equal(
        downsample(X_even, n=6, method='decimate'),
        np.array([[0.548814, 0.715189]])
    )

def test_downsample_single_decimate():
    """Downsample a single observation sequence with decimation"""
    assert_arrays_equal(
        downsample(X_odd, n=3, method='decimate'),
        np.array([
...
def test_downsample_single_average_max():
    ...
    assert_arrays_equal(
        downsample(X_even, n=6, method='average'),
        np.array([[0.62803445, 0.61834602]])
    )

def test_downsample_single_average():
    """Downsample a single observation sequence with averaging"""
    assert_arrays_equal(
        downsample(X_odd, n=3, method='average'),
        np.array([
...
def test_downsample_multiple_decimate_max():
    ...
    assert_all_arrays_equal(
        downsample(Xs, n=3, method='decimate'),
        [
...
def test_downsample_multiple_decimate():
    ...
    assert_all_arrays_equal(
        downsample(Xs, n=2, method='decimate'),
        [
            np.array([
...
def test_downsample_multiple_average_max():
    ...
    assert_all_arrays_equal(
        downsample(Xs, n=3, method='average'),
        [
...
def test_downsample_multiple_average():
    ...
    assert_all_arrays_equal(
        downsample(Xs, n=2, method='average'),
        [
            np.array([
...
def test_filtrate_single_median_max():
    ...
    assert_arrays_equal(
        filtrate(X_even, n=6, method='median'),
        np.array([
...
def test_filtrate_single_median():
    ...
    assert_arrays_equal(
        filtrate(X_odd, n=3, method='median'),
        np.array([
...
def test_filtrate_single_mean_max():
    ...
    assert_arrays_equal(
        filtrate(X_even, n=6, method='mean'),
        np.array([
...
def test_filtrate_single_mean():
    ...
    assert_arrays_equal(
        filtrate(X_odd, n=3, method='mean'),
        np.array([
            [0.31954031, 0.50636297],
            [0.21976634, 0.61511526],
